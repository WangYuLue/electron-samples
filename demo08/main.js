...
// 监听渲染程序发来的事件
electron__WEBPACK_IMPORTED_MODULE_0__["ipcMain"].on('something', function (event, data) {
    console.log('接收到render进程发送的消息', data);
    var myNotification = new electron__WEBPACK_IMPORTED_MODULE_0__["Notification"]({ title: '主进程通知', body: '接收到render进程发送的消息' });
    myNotification.show();
